      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-slate-400 max-w-2xl mx-auto">
            基于链上合约的 AMM 兑换池，支持 SUPER 与 USDT 的去中心化兑换。
          </p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-12">
          ...
          >
            ...
            <div className="bg-slate-950 rounded-2xl p-4 border border-slate-800 mb-2 hover:border-slate-700 transition-colors">
              ...
              <div className="flex justify-between items-center">
                ...
                <button className="flex items-center gap-2 bg-slate-800 hover:bg-slate-700 px-3 py-1.5 rounded-full transition-colors">
                  <div className="w-6 h-6 rounded-full bg-cyan-500/20 flex items-center justify-center text-cyan-400 text-xs font-bold">S</div>
            ...
            <div className="mt-6 space-y-3 text-sm">
              <div className="flex justify-between text-slate-400">
                <span>兑换比例</span>
                <span className="text-white">1000 SUPER = 1 USDT</span>
              </div>
              <div className="flex justify-between text-slate-400">
          ...
          <div className="flex-1 space-y-8 max-w-lg">
            {[
              { title: '去中心化流动池', desc: '基于 AMM 机制自动定价，不依赖中心化撮合。' },
              { title: '链上可验证', desc: '兑换逻辑与资金变更全部上链，可审计可追溯。' },
              { title: '钱包自托管', desc: '用户资产始终由自己的钱包控制。' },
            ].map((item, i) => (
              <motion.div
                key={i}
