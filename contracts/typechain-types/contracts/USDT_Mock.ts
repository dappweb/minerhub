...
export interface USDT_MockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface USDT_Mock extends BaseContract {
  connect(runner?: ContractRunner | null): USDT_Mock;
  waitForDeployment(): Promise<this>;

  interface: USDT_MockInterface;
